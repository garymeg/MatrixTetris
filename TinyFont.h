 ...
 */
void TFDrawChar(Adafruit_Protomatter* d, char value, char xo, char yo, int col);

/*
 * example:
  String lstr = String (tempM) + "C";
  int cc_red = matrix.color565 (255, 0, 0);
  xo = 1; yo = 1;
  TFDrawText (&display, lstr, xo, yo, cc_red);
 */
void TFDrawText(Adafruit_Protomatter* d, String text, char xo, char yo, int col);
